...
class OPCDriverDashboard extends StatefulWidget {
  final String id;
  ...
  @override
  _OPCDriverDashboardState createState() => _OPCDriverDashboardState();
}

class _OPCDriverDashboardState extends State<OPCDriverDashboard> {
