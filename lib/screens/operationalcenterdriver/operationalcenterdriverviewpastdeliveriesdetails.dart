...
class OperationalCenterDriverPastOrderDetails extends StatefulWidget {
  String? packageId;
  String? id;

  OperationalCenterDriverPastOrderDetails(this.id, this.packageId);
  //const OperationalCenterDriverPastOrderDetails({Key? key}) : super(key: key);

  @override
  State<OperationalCenterDriverPastOrderDetails> createState() => _OperationalCenterDriverPastOrderDetailsState();
}

class _OperationalCenterDriverPastOrderDetailsState extends State<OperationalCenterDriverPastOrderDetails> {
  bool _isLoading = true;

   String? vehicleType;
   String? fromOperationalcenterId;
  String? toOperationalcenterId;
  ...
  _getPackageData() async {
    await FirebaseFirestore.instance
      ...
      if (documentSnapshot.exists) {
        ...
        Driverid = documentSnapshot['operationalCenterDriverId'];
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Column(
                            ...
                            children: [
                              Text(
                                  "From Operational Center ID - ${fromOperationalcenterId}",
                                  style: TextStyle(fontSize: 14)),
                              Text(
                                  "Your Operational Center ID - ${toOperationalcenterId}",
                                  style: TextStyle(fontSize: 14)),
                              SizedBox(
                                height: 10,
                              ),
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text("Pickup Driver ID - ${Driverid}",
                                  style: TextStyle(fontSize: 14)),
                              SizedBox(
                                height: 10,
                              ),
