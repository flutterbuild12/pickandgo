...
class DropPackagesDropOffDriver extends StatefulWidget {
  ...
  String id;
  String opid;
  DropPackagesDropOffDriver(this.id, this.opid);
...
class _DropPackagesDropOffDriverState extends State<DropPackagesDropOffDriver> {
  ...
  Widget build(BuildContext context) {
    final fileName = file != null ? basename(result!.files.single.name) : 'No File Selected';
    final fileName2 = file2 != null ? basename(result2!.files.single.name) : 'No File Selected';
  ...
  Future uploadFile2Android() async {
    ...
    final fileName = basename(fileandroid2!.path);
    final destination = 'receiverimages/$fileName';
